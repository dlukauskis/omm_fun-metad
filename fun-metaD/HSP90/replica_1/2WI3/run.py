...
coords_file = '../../input/2WI3/solvated.rst7'
parm_file = '../../input/2WI3/solvatedHMR.prmtop'
...
lig = [ i for i in range(3294, 3312)]
p1 = [1172, 1186, 1205, 1219, 2051, 2067, 2081, 2585, 2607, 2623, 2642]
p2 = [519, 534, 553, 572, 583, 597, 608, 619, 631, 1219, 1238, 1254, 1280, 1287, 1306, 1313, 1388, 1454, 1473, 1480, 1863, 1879, 1886, 1906, 2081, 2116, 2564, 2571, 2585, 2607]
...
proj = BiasVariable(projection, 0.00, 3.70, 0.025, False, gridWidth = 200)
...
ext = BiasVariable(extent, 0.0, 1.35, 0.05, False, gridWidth = 200)
