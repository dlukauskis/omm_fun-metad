...
coords_file = '../../input/3EKO/solvated.rst7'
parm_file = '../../input/3EKO/solvatedHMR.prmtop'
...
lig = [ i for i in range(3421, 3446)]
p1 = [1298, 1312, 1331, 2664, 2678, 2700, 2716]
p2 = [627, 646, 665, 676, 690, 701, 712, 724, 734, 765, 1331, 1347, 1359, 1373, 1380, 1399, 1406, 1469, 1481, 1533, 1547, 1979, 2174, 2209, 2657, 2664, 2678, 2700]
