...
coords_file = '../../input/2VTM/solvated.rst7'
parm_file = '../../input/2VTM/solvatedHMR.prmtop'
...
lig = [ i for i in range(4848, 4863)]
p1 = [1002, 1021, 2044, 2341, 2360, 2370, 2382, 2402, 2409]
p2 = [162, 181, 268, 284, 305, 468, 484, 494, 513, 1021, 1037, 1285, 1301, 1321, 1336, 1356, 1375, 1392, 1409, 2152, 2169, 2183, 2202, 2221, 2341, 2360, 2370]
